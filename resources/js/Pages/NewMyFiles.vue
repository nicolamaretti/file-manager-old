        ...
        <div class="flex-1 overflow-auto">
            <table class="min-w-full shadow ring-1 ring-black ring-opacity-5 border sm:rounded-lg">
                ...
                <tr>
                    ...
                    <th v-if="isUserAdmin" class="text-sm font-semibold text-gray-900 px-6 py-4 text-left">
                        Owner
                    </th>
                    <th class="text-sm font-semibold text-gray-900 px-6 py-4 text-left">
                        Last Modified
                ...
                <tr v-if="folders"
                    ...
                    <!-- l'admin vede anche l'owner -->
                    <td v-if="isUserAdmin" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {{ folder.owner }}
                    </td>
...
<!--                                        &lt;!&ndash; 2) visualizzazione file &ndash;&gt;-->
<!--                                        <div v-if="files"-->
<!--                                             v-for="file in files.data"-->
<!--                                             :key="file.id"-->
<!--                                             :class="(selectedFiles[file.id] || allSelected) ? 'bg-blue-50' : 'bg-white'"-->
...
<!--                            &lt;!&ndash; controllo per la home page dell'admin: all'inizio, files è null e fa crashare l'app &ndash;&gt;-->
<!--                            <div v-if="files && folders">-->
<!--                                <div v-if="!files.data.length && !folders.data.length"-->
<!--                                     class="py-8 text-center text-sm text-gray-400">-->
<!--                                    There is no data in this folder-->
...
function openFolder(folderId = null) {
    console.log(onlyFavourites.value)
    ...
    // openFolderForm.get(route('newMyFiles'), {
    //     preserveScroll: true,
    //     preserveState:true,
    //     onSuccess: (data) => {
    //         console.log(data)
...
function showOnlyFavourites() {
    // chiamo openFolder per farmi ritornare solo le folder preferite
    // openFolder()
...
console.log('newfilesblablabla', props);
