...
<!--      :rootFolderId="rootFolderId"-->
    ...
    <!--                    </td>-->
    <!--                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 flex items-center">-->
    <!--                        <FileIcon class="inline-block mr-3"/>-->
    <!--                        {{ file.file_name }}-->
    <!--                    </td>-->
    <!--                </tr>-->
    <!--                </tbody>-->
...
import SimpleTableInCard from "@/Components/MyComponents/Table.vue";
