<template>
    <DialogModal :show="props.modelValue" max-width=lg>
        ...
        <template #content>
            ...
            <TextInput type="text" ref="emailInput" id="shareEmail" v-model="email"
                :class="errorMessage ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''"
                class="block w-full mt-1" placeholder="Enter Email Address" @keyup.enter="share" />
        ...
        <template #footer>
            ...
            <PrimaryButton class="ml-3" @click="share">
                Submit
            </PrimaryButton>
        </template>
    </DialogModal>
