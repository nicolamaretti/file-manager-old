<template>
    ...
    <MoveModal v-model="modal"
               :move-file-ids="moveFileIds"
...
<script setup>
import {ref} from "vue";
import MoveModal from "@/Components/ExtraComponents/MoveModal.vue";
...
// Methods
function showModal() {
    // prima di mostrare la modale vado a prendere le folders che devo mostrare
    // getFoldersToSelect();

    modal.value = true;
}

// function getFoldersToSelect() {
